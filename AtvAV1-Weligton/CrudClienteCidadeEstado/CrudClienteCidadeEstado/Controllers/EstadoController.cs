...
namespace CrudClienteCidadeEstado.Controllers
{
    public class EstadoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EstadoId,Sigla,Nome")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstadoId,Sigla,Nome")] Estado estado)
        {
